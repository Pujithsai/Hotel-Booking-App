    ...
    if (showAllPhotos) {
        return (
          <div className='absolute inset-0 bg-black text-white min-h-screen'>
            <div className='bg-black p-8 gap-4 grid'>
                <div>
                    <h2 className='text-3xl mr-48'>Photos of {place.title}</h2>
                    <button onClick={() => setShowAllPhotos(false)} className='py-2 right-12 top-8 px-4 rounded-2xl gap-1 flex fixed shadow shadow-black bg-white text-black'>
