    ...
    return (
        <div className='grid mt-2 gap-2 grid-cols-2 md:grid-cols-4 lg:grid-cols-6'>
            <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer'>
                                <input type='checkbox' checked={selected.includes('Wi-fi')} name='Wi-fi' onChange={handleClick}/>
                            ...
                            <label className='border p-4 flex rounded-xl gap-2 items-center cursor-pointer'>
                                <input type='checkbox' checked={selected.includes('Parking-Spot')} name='Parking-Spot' onChange={handleClick}/>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
